...
| Debug Error Sensor | GPIO 34 | INPUT       | EXTERNAL*   | Debug error trigger (dev only) |

*GPIO 34 is input-only without internal pulls. Requires external pull-down resistor for stable operation in debug builds only.
