...
public:
    ...
    using ComponentFactory = std::function<std::unique_ptr<IComponent>(IDisplayProvider*)>;
    ...
    std::unique_ptr<IComponent> createComponent(const std::string& name, IDisplayProvider* display);
