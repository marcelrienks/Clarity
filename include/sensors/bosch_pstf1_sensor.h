...
class BoschPstf1Sensor : public ISensor<OilSensorTypes>
{
public:
    BoschPstf1Sensor();

    void init() override;
    Reading get_reading(std::optional<OilSensorTypes> type = std::nullopt) override;
...
private:
    ...
    Reading get_pressure_reading();
    Reading get_temperature_reading();
};