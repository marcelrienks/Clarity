...
/**
 * @class ClarityWidget
 * @brief Clarity branding and logo display widget
 * 
 * @details This widget renders the Clarity brand logo/text for use in
