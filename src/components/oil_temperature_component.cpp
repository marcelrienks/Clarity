...
const lv_image_dsc_t* OilTemperatureComponent::get_icon() const
{
    return &oil_temp_regular;
}

int32_t OilTemperatureComponent::get_scale_min() const
{
    return _scale_min;
}

int32_t OilTemperatureComponent::get_scale_max() const
{
    return _scale_max;
}

int32_t OilTemperatureComponent::get_danger_zone() const
{
    return _danger_zone;
}

lv_align_t OilTemperatureComponent::get_alignment() const
{
    return LV_ALIGN_BOTTOM_MID;
}

lv_scale_mode_t OilTemperatureComponent::get_scale_mode() const
{
    return LV_SCALE_MODE_ROUND_INNER;
}

int32_t OilTemperatureComponent::get_rotation() const
{
    return 30; // starting angle (0 = 3 o'clock)
}

int32_t OilTemperatureComponent::get_angle_range() const
{
    return 120; // range in degrees for the span of the scale
}

bool OilTemperatureComponent::is_danger_condition(int32_t value) const
{
    return value >= _danger_zone; // High temperature is dangerous
}

int32_t OilTemperatureComponent::map_value_for_display(int32_t value) const
{
...
void OilTemperatureComponent::setup_danger_zone(lv_scale_section_t *section) const
{
...
int32_t OilTemperatureComponent::get_icon_y_offset() const
{
