...
std::unique_ptr<LvglDisplayProvider> ProviderFactory::createLvglDisplayProvider(DeviceProvider *deviceProvider)
{
    ...
    if (!deviceProvider)
    {
        ...
        ErrorManager::Instance().ReportCriticalError(
            "ProviderFactory", "Cannot create LvglDisplayProvider - DeviceProvider dependency is null");
        return nullptr;
    }
    ...
    if (!deviceProvider->screen)
    {
        ...
        ErrorManager::Instance().ReportCriticalError(
            "ProviderFactory", "Cannot create LvglDisplayProvider - DeviceProvider screen is null");
        return nullptr;
    }
