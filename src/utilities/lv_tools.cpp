...
lv_obj_t* LvTools::create_blank_screen(IStyleService* styleService)
{
    log_d("Creating blank screen with theme background");
    
    lv_obj_t *screen = lv_obj_create(NULL);
    LvTools::reset_screen(screen, styleService);
...
/// @param styleService Style service for theme application
void LvTools::reset_screen(lv_obj_t *screen, IStyleService* styleService)
{
