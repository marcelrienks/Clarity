...
void SplashPanel::Init(IGpioProvider* gpio)
{
...
void SplashPanel::Load(std::function<void()> callbackFunction, IGpioProvider* gpio)
{
...
void SplashPanel::Update(std::function<void()> callbackFunction, IGpioProvider* gpio)
{
    callbackFunction();
}
